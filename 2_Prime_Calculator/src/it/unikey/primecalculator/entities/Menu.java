...
public abstract class Menu {
  ...
  public static void launchMenu() {
    ...
    do {
      ...
      while (
        !(
          restartCalculator.equalsIgnoreCase("y") ||
      ...
      if (restartCalculator.equalsIgnoreCase("y")) isNewIteration =
        true; else if (restartCalculator.equalsIgnoreCase("n")) isNewIteration =
        false;
